...
(
    id           varchar   not null
        constraint pk_report_subscription
            primary key,
    package_id   varchar   not null
        constraint report_subscription_package_group_id_fk
            references package_group
            on update cascade on delete cascade,
    user_id      varchar   not null
        constraint report_subscription_user_data_id_fk
            references user_data
            on update cascade on delete cascade,
    build_id     varchar,
...
create index report_subscription_user_id_idx
    on report_subscription (user_id, package_id);
